...
/*let userDatas = [{
    ...
    age: 30,
    info: 'happy',
    image: 'https://wl-adme.cf.tsp.li/resize/728x/jpg/419/9f0/02decf5622a4677eb799ab8118.jpg'
},
    {
        name: 'Marya',
        surname: 'Ferasymenko',
...
for (let userData of userDatas) {
    document.write(`<div class="wrapOfUserData"> ${userData.name} ${userData.surname} ${userData.age} ${userData.info} <img src="${userData.image}" alt="woman"></div>`);
} */
...
for (let product of products) {
    document.write(`<div class="product-card"> <div class="product-title"> <h3> ${product.title} price - ${product.price} </h3></div> <img src="${product.image}" alt="product"> </div>`);
}*/


/*                                           Lesson 2 Homework hw2.html*/
...
document.write (`<div class="wrapOfUser">`);
for (let user of usersList) {
    document.write (`<div class="users-box"> <div class="user-block"><h2> ${user.id} ${user.name} ${user.username} </h2> <h3> ${user.email} ${user.phone}</h3> </div> <div class="address-block" <p> ${user.address.city} </p> <p>${user.address.street} </p> <p> ${user.address.suite} </p> <p>${user.address.zipcode}</p> </div> </div>`)
}
